...
export const metadata: Metadata = {
  title: "Galeri Desa",
  description: "Foto dan video kegiatan Desa Pojok Klitih. Dokumentasi momen berharga kehidupan desa kami.",
};
    ...
    <div className="pt-20">
      <div className="bg-gradient-to-br from-purple-700 to-purple-900 py-16 text-white relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          <p className="text-purple-200 text-lg">{galleries.length} foto tersedia · Kenangan indah Desa Pojok Klitih</p>
        </div>
      </div>
